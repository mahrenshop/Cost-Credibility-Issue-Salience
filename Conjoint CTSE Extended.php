...
$featurearray = array("Costs" => array("Raising income tax","Less money for other issues","Disclosure of private data","No costs"),"Policy Issue" => array("Anti-Corruption","Economy","Domestic Security"),"Effectiveness" => array("Has been shown by experts to perform well","Has been shown by experts to have little effect"),"Gender" => array("Female","Male"),"Credibility" => array("Has a reputation for keeping campaign promises","Has a reputation for not keeping campaign promises"),"Party" => array("Labour Party","Conservative Party"));
